...
import static se.alex.lexicon.Exercises.*;
...
public class App {
        ...
        do {
            ...
            switch (number) {
                ...
                case 13:
                    ...
                    break;
                default:
                    System.out.println("Invalid option. Please choose a number between 0 and 13.");
            }
        } while (!done);
        SCANNER.close();
    }
    ...
    public static String menu() {
        ...
        stringBuilder.append("12.\tUsing findAndSort() find everyone born before 1950 sorted reversed by latest to earliest.\n");
